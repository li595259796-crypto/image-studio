...
export const copy: Record<Locale, LocaleCopy> = {
  zh: {
    ...
    scenario: {
      ...
      resultAlt: '生成结果',
      waitingTitle: '正在生成图片',
      waitingDescription: 'AI 正在处理，可能需要 1-5 分钟。请保持页面打开，我们会在完成后展示结果。',
      requestTimeout: 'AI 处理超时了，请再试一次。',
  ...
  en: {
    ...
    scenario: {
      ...
      waitingDescription: 'The AI is processing. This may take 1-5 minutes. Keep this page open and the result will appear here.',
      requestTimeout: 'The AI processing timed out. Please try again.',
